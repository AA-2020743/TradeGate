...
function MacroDashboard({ data }) {
  ...
  const currencyMomentum = [
    { key: 'eurUsd', currency: 'EUR', name: 'Euro', driver: 'ECB balance sheet and rate cycle' },
    { key: 'yenPerUsd', currency: 'JPY', name: 'Yen', driver: 'BoJ policy and carry dynamics' },
